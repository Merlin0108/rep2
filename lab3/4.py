...
print("Через 10 000 дней вам будет", future_date_10000_days.strftime("%Y-%m-%d"))
print("Через 1 000 000 минут вам будет", future_date_1000000_minutes.strftime("%Y-%m-%d"))
print("Через 1 000 000 000 секунд вам будет", future_date_1000000000_seconds.strftime("%Y-%m-%d"))
